<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        ...
        <br>
        <form class="form-horizontal" method="post" action="<?= base_url('admin/divisi/edit_save') ?>">
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label text-muted">ID Divisi</label>
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="id" name="id" value="<?= $divisi['id'] ?>" required readonly>
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    ...
                    <a class="btn btn-success" href="<?= base_url('admin/divisi'); ?>" type="submit"><i class="bi bi-box-arrow-left"></i> Kembali</a></li>
                </div>
            </div>
    </div>
    </div>
