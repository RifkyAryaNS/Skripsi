<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        ...
        <div class="card" style="width:auto;">
            <div class="card-body">
                <a class="btn btn-success btn-sm pull-right bi bi-plus" href="<?= base_url("admin/divisi/tambah") ?>">Tambah</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-warning btn-sm bi bi-pencil-fill" href="<?= base_url("admin/divisi/edit/{$div['id']}") ?>"></a>
                                    <a class="btn btn-danger btn-sm bi bi-eraser-fill" onclick="return confirm('Apakah anda yakin untuk menghapus data?')" href="<?= base_url("admin/divisi/hapus/{$div['id']}") ?>"></a>
                                </td>
