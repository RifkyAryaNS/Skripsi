<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        ...
        <br>
        <a class="btn btn-success btn-sm pull-right bi bi-plus" href="<?= base_url("admin/pegawai/tambah") ?>">Tambah</a>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-warning btn-sm bi bi-pencil-fill" href="<?= base_url("admin/pegawai/edit/{$peg['id']}") ?>"></a>
                                    <a class="btn btn-danger btn-sm bi bi-eraser-fill" onclick="return confirm('Apakah anda yakin untuk menghapus data?')" href="<?= base_url("admin/pegawai/hapus/{$peg['id']}") ?>"></a>
                                </td>
