<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        <br>
        <center>
            <h3><b>Edit Jabatan</b></h3>
        </center>
        <h3>
            <?= validation_errors(); ?>
        </h3>
        <br>
        <form class="form-horizontal" method="post" action="<?= base_url('admin/jabatan/edit_save') ?>">
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label text-muted">ID Jabatan</label>
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="id" name="id" value="<?= $jabatan['id'] ?>" required readonly>
                    </div>
                </div>
            </div>
            <br>
            <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="id_divisi" name="id_divisi" value="<?= $jabatan['id_divisi'] ?>" required>
                    </div>
                </div>
            </div>
            <br>
            <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="nama_divisi" name="nama_jabatan" value="<?= $jabatan['nama_jabatan'] ?>" required>
                    </div>
                </div>
            </div>
            <br>
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    ...
                    <a class="btn btn-success" href="<?= base_url('admin/jabatan
                    '); ?>" type="submit"><i class="bi bi-box-arrow-left"></i> Kembali</a></li>
                </div>
            </div>
    </div>
    </div>
