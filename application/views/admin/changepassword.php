<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        ...
        <form class="form-horizontal" method="post" action="<?= base_url('admin/pengguna/change_save') ?>">
            <div class="mb-3 row">
            ...
            <br>
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label text-muted">Password Lama</label>
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="password" class="form-control" id="passwordlama" name="passwordlama" required placeholder="password lama" value="<?= $pengguna['password'] ?>">
                    </div>
                </div>
            </div>
            <br>
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label text-muted">Password Baru</label>
                <div class="col-sm-6">
                    <div class="input-group">
