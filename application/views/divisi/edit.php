<?php if ($this->session->userdata('email')) { ?>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg" aria-labelledby="dropdownMenuLink">
                                <li><a class="dropdown-item" href="<?= base_url('data_perpanjang/index'); ?>"><i class="bi bi-table"></i> Data Penilaian / Evaluasi</a>
                                </li>
                                <li><a class="dropdown-item" href="<?= base_url('hasil_perpanjang/index'); ?>"><i class="bi bi-table"></i> Hasil Penilaian / Evaluasi</a>
                                </li>
                                <li><a class="dropdown-item" href="<?= base_url('rekomen_perpanjang/index'); ?>"><i class="bi bi-table"></i> Data Rekomendasi Pegawai</a></li>
                            </ul>
                        </div>
                    </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        <br>
        <center>
            <h3><b>Edit Divisi</b></h3>
        </center>
        <h3>
            <?= validation_errors(); ?>
        </h3>
        <br>
        <form class="form-horizontal" method="post" action="<?= base_url('divisi/edit_save') ?>">
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="nama_divisi" name="nama_divisi" value="<?= $nama_divisi ?>" required>
                    </div>
                </div>
            </div>
            <br>
