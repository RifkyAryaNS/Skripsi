<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        <br>
        <center>
            <h4><b>Hasil Penilaian / Evaluasi Pegawai Perpanjangan Kontrak</b></h4>
        </center>
    </div>
    <br>
    <br>
            ...
            <table class="table" id="myTable">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        if ($total_nilai >= 70) {
                            $tra["rekomendasi"] = "<div class='btn btn-success'><b>Di Rekomendasikan</b></div>";
                        } else {
                            $tra["rekomendasi"] = "<div class='btn btn-danger'>Tidak Direkomendasikan</div>";
                        }
