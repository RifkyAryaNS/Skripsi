<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        <br>
        <center>
            <h4><b>Rekomendasi Promosi Pegawai</b></h4>
        </center>
    </div>
    <br>
    <br>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    ...
                    // $promosi = array_filter($promosi, function ($item) {
                    //     return $item['nilai'] * 20 >= 75;
                    // });
                    // foreach ($promosi as $pro) :
                    //     $persentase = $pro['nilai'] / $totalNilai;
                    $persentase = $promosi[0]['nilai'] / $totalNilai;
                    ?>
                    <?php
                    $total_nilai = $promosi[0]['nilai'];
                    if ($total_nilai >= 3.9) {
                        $promosi["rekomendasi"] = "<div class='btn btn-success'><b>Promosi Jabatan</b></div>";
                    } else {
                        $promosi["rekomendasi"] = "Tidak Direkomendasikan";
                    }

                    ?>
                    <tr>
                        <td><?= $no++ ?></td>
                        <td><?= $promosi[0]['namepegawai']; ?></td>
                        <td><?= $promosi[0]['namenip']; ?></td>
                        <td><?= $promosi[0]['namadiv']; ?></td>
                        <td><?= $promosi[0]['nilai']; ?></td>
